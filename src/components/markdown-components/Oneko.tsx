...
import { useEventListener, useTimeoutFn } from 'solidjs-use';
import styles from './Oneko.module.css';

export default function Oneko({ cat, pettable = true, scrolls = true }: {
    cat?: string;
    pettable?: boolean;
    scrolls?: boolean;
}) {
    ...
    let nekoElRef: HTMLElement;

    onMount(() => {
        if (isReducedMotion) return;
    
        setStopped(false);
        const nekoEl = nekoElRef;
